    ...
    <div class="<?php echo $this->get_classes('box'); ?>" <?php $this->the_product_container(); ?>>
        ...
        <div class="aawp-box__thumb">
            <a class="aawp-box__image-link"
               href="<?php echo $this->get_product_url(); ?>" title="<?php echo $this->get_product_image_link_title(); ?>" rel="nofollow" target="_blank">
        ...
        <div class="aawp-box__content">
            <a class="aawp-box__title" href="<?php echo $this->get_product_url(); ?>" title="<?php echo $this->get_product_link_title(); ?>" rel="nofollow" target="_blank"><?php echo $this->get_product_title(); ?></a>
        ...
        <div class="aawp-box__footer">
            ...
            <?php } ?>
            <?php if ( $this->get_product_pricing( 'saved' ) ) { ?>
