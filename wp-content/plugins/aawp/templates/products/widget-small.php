...
<div class="<?php echo $this->get_product_container_classes( 'aawp-product aawp-product--widget-small' ); ?>" <?php $this->the_product_container(); ?>>
    ...
    <span class="aawp-product__inner">
        <a class="aawp-product__image-link aawp-product__image" href="<?php echo $this->get_product_image_link(); ?>" title="<?php echo $this->get_product_image_link_title(); ?>" rel="nofollow" target="_blank" style="background-image: url('<?php echo $this->get_product_image('medium'); ?>');"></a>
