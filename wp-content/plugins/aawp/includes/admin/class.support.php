...
if (!class_exists('AAWP_Support')) {
    ...
    class AAWP_Support {
        ...
        public function __construct()
        {
	        ...
	        $this->simplexml = $this->check_simplexml();
        ...
        public function settings_section_render() {
            ...
            <table class="widefat">
                ...
                <tr>
                    <th><?php printf( esc_html__( 'PHP "%1$s" extension', 'aawp' ), 'XML' ); ?></th>
                    <td>
		                <?php echo (isset ($this->simplexml['enabled']) && $this->simplexml['enabled']) ? $enabled : $disabled; ?>
                    </td>
                </tr>
                <tr class="alternate">
            ...
            <div id="poststuff">
                <h1>
                    <img class="aawp-icon-settings"
                         src="<?php echo AAWP_PLUGIN_URL . 'public/assets/img/icon-settings.png'; ?>"/>
                    <?php _e( 'Support', 'aawp' ); ?>
                </h1>
